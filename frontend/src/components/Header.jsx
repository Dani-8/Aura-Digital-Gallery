    ...
    <header className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
      ...
      <div className="relative flex-1 md:w-64">
        ...
        <input
          ...
          className="w-full pl-10 bg-zinc-900/50 border border-zinc-700 focus:border-zinc-600 rounded-lg py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none"
          value={searchTerm}
